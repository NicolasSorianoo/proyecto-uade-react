...
const CarroDeCompras = ({allProducts, setAllProducts, total, setTotal, setCountProducts, countProducts}) => {

    const [active, setActive] = useState(false)

    const deleteProduct = (producto) => {
        const resultado = allProducts.filter(item => item.id !== producto.id)
